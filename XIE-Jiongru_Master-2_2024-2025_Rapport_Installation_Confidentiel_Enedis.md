...
- ### 1.1 Présentation d'Enedis  
  ...
  1. **Planification trimestrielle (PI Planning)** : Alignement inter-équipes (ex. coopération avec IDS).  
  2. **Rôles clés** :  
  ...
  1. **SIG chez Enedis** :  
    - **Données critiques** : 80+ To de données haute précision (LiDAR, drones).  
    - **Applications multisectorielles** : Transport autonome, sécurité civile.  
  2. **Écosystème** :  
...
### 1.3 Installation matérielle et logistique
...
## **4. Planification prévisionnelle (时间规划)**

- #### **4.1 Calendrier des phases (阶段划分)**
...
> _Voir annexe A1 : Le diagramme illustre les phases clés, avec une marge de 5 jours prévue pour les retards potentiels liés aux validations internes._

---

### **提交要求**

- 发送至：amaury.zarzelli@ign.fr + victor.coindet@ensg.eu + cyril.condez-godziemba@enedis.fr +  philippe.genot@enedis.fr + `stages@ensg.eu`  
...
| **LiDAR**              | Technologie      | *Light Detection and Ranging* : Capteur pour modélisation 3D haute précision. |
